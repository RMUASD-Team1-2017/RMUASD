...
int main(int argc, char **argv)
{
    ...
    ros::Publisher test_pub = n.advertise<aed_gcs_logic::waypoints>("/drone_logic/mission_path", 1);

    aed_gcs_logic::waypoints waypoints_msg;
    sensor_msgs::NavSatFix sat_msg;
    sat_msg.latitude = 10.40;
    sat_msg.longitude = 10.50;

    waypoints_msg.path.push_back(sat_msg);
    waypoints_msg.path.push_back(sat_msg);
    waypoints_msg.path.push_back(sat_msg);

    std::cout << "Publishing" << std::endl;
    test_pub.publish(waypoints_msg);
